                ...
                <div class="pb-16 mb-8 border-b border-gray-400">
                  ...
                  <div className="py-6 px-8 mb-4 bg-gray-600 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <a className="text-lg font-bold text-white" target="_blank" href={`tel:${useGetChunk("contact_info_phone")}`}>
                        <Chunk identifier="contact_info_phone" />
                      </a>
                    </div>
                  </div>
                  <div className="py-6 px-8 mb-4 bg-gray-600 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <a className="text-lg font-bold text-white" target="_blank" href={`mailto:${useGetChunk("contact_info_email")}`}>
                        <Chunk identifier="contact_info_email" />
                      </a>
                    </div>
                  </div>
                  <div className="py-6 px-8 mb-4 bg-gray-600 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <a className="text-lg font-bold text-white" target="_blank" href={`http://maps.google.com/?q=${useGetChunk("contact_info_location")}`}>
                        <Chunk identifier="contact_info_location" />
                      </a>
                    </div>
                  </div>
                </div>
