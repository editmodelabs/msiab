        ...
        <div className="flex flex-wrap items-center -mx-4">
          <div className="w-full lg:w-2/5 px-4 mb-20 lg:mb-0">
            <div className="lg:max-w-lg">
              <h2 className="mb-12 text-6xl 2xl:text-7xl font-bold font-heading text-white"><Chunk contentKey="brand_statement"/></h2>
              <p className="text-lg text-gray-200"><Chunk contentKey="brand_statement_desc"/></p>
            </div>
          </div>
