          ...
          {(getChunk, chunk) => {
            return (
              <div className="flex items-center">
                <ChunkFieldValue identifier="Avatar" className="h-48 w-1/3 object-cover rounded"/>
                <div className="pl-10 w-2/3">
                  ...
                  {getChunk(chunk, "FacebookURL") && (
                    <a 
                      ...
                      <svg className="text-white" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http:www.w3.org/2000/svg">
                        <path fillRule="evenodd" clipRule="evenodd" d="M12.4986 19V11.7022H14.995L15.3695 8.85725H12.4986V7.04118C12.4986 6.21776 12.7308 5.65661 13.936 5.65661L15.4706 5.65599V3.11138C15.2052 3.07756 14.2942 3 13.2339 3C11.0198 3 9.50399 4.32557 9.50399 6.75942V8.85725H7V11.7022H9.50399V19H12.4986Z" fill="currentColor"/>
...
AboutUs.getLayout = (page) => <Layout pageName="AboutUs">
  {page}</Layout>;
