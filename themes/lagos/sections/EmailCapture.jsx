        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap items-center">
            <div className="mb-4 w-full lg:w-auto lg:mr-8 text-center">
              ...
              <svg className="w-6 h-6 text-primary" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path></svg>
              </div>
            </div>
            ...
            <div className="w-full lg:w-2/5">
              <form action={`https://formsubmit.co/${useGetChunk('email_capture_email_address')}`} method="post">
                <div className="max-w-md lg:max-w-sm mx-auto flex flex-wrap items-center">
                  <input className="flex-grow py-3 px-4 mr-4 text-xs rounded leading-loose" type="email" placeholder={useGetChunk("email_capture_input_placeholder")} />
                  <button className="flex-none py-2 px-6 rounded-t-xl rounded-l-xl text-primary bg-white font-bold leading-loose transition duration-200">
