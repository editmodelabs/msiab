...
import { Chunk, useGetChunk, ChunkCollection } from "editmode-react";
              ...
              {(getChunk, chunk) => (
                <>
                  ...
                  <div class="w-full lg:w-1/5 px-3">
                    <a class="inline-block mt-4 lg:mt-0 py-2 px-6 rounded-l-xl rounded-t-xl bg-primary hover:bg-green-700 text-white font-bold leading-loose transition duration-200" href={getChunk(chunk,"Link")}>
