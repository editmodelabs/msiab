              ...
              {(getChunk, chunk) => (
                <>
                  ...
                  <div className="w-full lg:w-2/5 px-3">
                    <ul className="mb-4 text-gray-500">
                      <li className="mb-4 flex">
                        ...
                        <svg className="mr-2 w-5 h-5 text-primary" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 20 20" fill="currentColor">
                  ...
                  <div className="w-full lg:w-1/5 px-3">
                    <a className="inline-block mt-4 lg:mt-0 py-2 px-6 rounded-l-xl rounded-t-xl bg-primary hover:bg-green-700 text-white font-bold leading-loose transition duration-200" href={getChunk(chunk,"Link")}>
...
Pricing.getLayout = (page) => (
  <Layout pageName="Pricing">{page}</Layout>
);
